...
$stmt = mysqli_prepare($conn, "SELECT * FROM biodata_mahasiswa WHERE cmid = ? LIMIT 1");
if (!$stmt) {
...
if (!$row) {
    $_SESSION['flash_error_bio'] = 'Data mahasiswa tidak ditemukan.';
    redirect_ke('read_biomahasiswa.php');
}
...
<body>
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="read_biomahasiswa.php">Data Mahasiswa</a></li>
                <li><a href="edit_bio.php">Edit Biodata</a></li>
            </ul>
        </nav>
    </header>
    ...
    <main>
        <section id="biodata" style="max-width: 800px; margin: 20px auto;">
            ...
            <form action="proses_edit_bio.php" method="POST">
                ...
                <label for="txtTglLhrEdit"><span>Tanggal Lahir:</span>
                    <input type="text" id="txtTglLhrEdit" name="txtTglLhr" 
                ...
                <a href="read_biomahasiswa.php" style="background-color: #b4b4b4; color: #272727; 
